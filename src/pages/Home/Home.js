                ...
                <div className="black-block">
                    ...
                    <Grid container spacing={{xs: 1, md: 6}} columns={{xs: 4, sm: 8, md: 12}}>
                        <Grid item xs={4} sm={4} md={4}>
                            <h3>Sardoche</h3>
                            <HomeStream
                                url="https://www.twitch.tv/sardoche&parent=http://rubycouz.xyz"
                            />
                        </Grid>
                        <Grid item xs={4} sm={4} md={4}>
                            <h3>Mojitomangue</h3>
                            <HomeStream
                                url="https://www.twitch.tv/mojitomangue&parent=http://rubycouz.xyz"
                            />
                        </Grid>
                        <Grid item xs={4} sm={4} md={4}>
                            <h3>At0mium</h3>
                            <HomeStream
                                url="https://www.twitch.tv/at0mium&parent=http://rubycouz.xyz"
                            />
                        </Grid>
                    </Grid>
                    <Grid container spacing={{xs: 1, md: 6}} columns={{xs: 4, sm: 8, md: 12}}>
                        <Grid item xs={4} sm={4} md={4}>
                            <h3>Solary</h3>
                            <HomeStream
                                url="https://www.twitch.tv/solary&http://rubycouz.xyz"
                            />
                        </Grid>
                        <Grid item xs={4} sm={4} md={4}>
                            <h3>Aspigtv</h3>
                            <HomeStream
                                url="https://www.twitch.tv/aspigtv&parent=http://rubycouz.xyz"
                            />
                        </Grid>
                        <Grid item xs={4} sm={4} md={4}>
                            <h3>Mooters</h3>
                            <HomeStream
                                url="https://www.twitch.tv/mooters&parent=http://rubycouz.xyz"
                            />
                        </Grid>
                    </Grid>
                </div>
